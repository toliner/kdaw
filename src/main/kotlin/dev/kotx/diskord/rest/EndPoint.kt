...
open class EndPoint(
    ...
    open class Channel(method: HttpMethod, channelId: Long, path: String) :
        EndPoint(method, "/channels/$channelId$path") {
        ...
        open class Invite(method: HttpMethod, channelId: Long, path: String) : Channel(method, channelId, "/invites$path") {

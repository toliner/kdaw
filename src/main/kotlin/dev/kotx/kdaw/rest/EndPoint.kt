...
open class EndPoint internal constructor(
    ...
    sealed class Channel(method: HttpMethod, channelId: Long, path: String = "") : EndPoint(method, "/channels/$channelId$path") {
        ...
        sealed class Pin(method: HttpMethod, channelId: Long, path: String = "") : Channel(method, channelId, "/pins$path") {
        ...
        sealed class Recipient(method: HttpMethod, channelId: Long, userId: Long) : Channel(method, channelId, "/recipients/$userId") {
        ...
        sealed class Invite(method: HttpMethod, channelId: Long) : Channel(method, channelId, "/invites") {
            class List(channelId: Long) : Invite(HttpMethod.Get, channelId)
            class Create(channelId: Long) : Invite(HttpMethod.Post, channelId)
        }

        sealed class Permission(method: HttpMethod, channelId: Long, path: String = "") : Channel(method, channelId, "/permissions$path") {
        ...
        sealed class Thread(method: HttpMethod, channelId: Long, path: String = "") : Channel(method, channelId, path) {
            ...
            sealed class Members(method: HttpMethod, channelId: Long, path: String = "") : Thread(method, channelId, "/thread-members$path") {
        ...
        sealed class Message(method: HttpMethod, channelId: Long, path: String = "") : Channel(method, channelId, "/messages$path") {
            ...
            sealed class Reaction(method: HttpMethod, channelId: Long, messageId: Long, path: String = "") : Message(method, channelId, "/$messageId/reactions$path") {
    ...
    sealed class Emoji(method: HttpMethod, guildId: Long, path: String = "") : EndPoint(method, "/guilds/$guildId/emojis$path") {
    ...
    sealed class Guild(method: HttpMethod, path: String = "") : EndPoint(method, "/guilds$path") {
        ...
        sealed class WelcomeScreen(method: HttpMethod, guildId: Long) : Guild(method, "/$guildId/welcome-screen") {
        ...
        sealed class VoiceState(method: HttpMethod, guildId: Long, path: String = "") : Guild(method, "/$guildId/voice-states$path") {
        ...
        sealed class Integration(method: HttpMethod, guildId: Long, path: String = "") : Guild(method, "/$guildId/integrations$path") {
        ...
        sealed class Widget(method: HttpMethod, guildId: Long, path: String = "") : Guild(method, "/$guildId$path") {
        ...
        sealed class Channel(method: HttpMethod, guildId: Long) : Guild(method, "/$guildId/channels") {
        ...
        sealed class Member(method: HttpMethod, guildId: Long, path: String = "") : Guild(method, "/$guildId/members$path") {
            ...
            sealed class Role(method: HttpMethod, guildId: Long, userId: Long, roleId: Long) : Member(method, guildId, "/$userId/roles/$roleId") {
        ...
        sealed class Ban(method: HttpMethod, guildId: Long, path: String = "") : Guild(method, "/$guildId/bans$path") {
        ...
        sealed class Role(method: HttpMethod, guildId: Long, path: String = "") : Guild(method, "/$guildId/roles$path") {
        ...
        sealed class Prune(method: HttpMethod, guildId: Long) : Guild(method, "/$guildId/prune") {
            class Get(guildId: Long) : Prune(HttpMethod.Get, guildId)
            class Begin(guildId: Long) : Prune(HttpMethod.Post, guildId)
        }

        sealed class Template(method: HttpMethod, path: String = "") : Guild(method, path) {
    ...
    sealed class Invite(method: HttpMethod, inviteCode: String) : EndPoint(method, "/invites/$inviteCode") {
    ...
    sealed class StageInstance(method: HttpMethod, path: String = "") : EndPoint(method, "/stage-instances$path") {
    ...
    sealed class User(method: HttpMethod, path: String = "") : EndPoint(method, "/users$path") {
